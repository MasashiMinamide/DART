...
!
! $Id: DEFAULT_obs_kind_mod.F90 11612 2017-05-08 22:18:42Z nancy@ucar.edu $
...
integer, parameter, public :: max_defined_types_of_obs =     3
...
obs_type_info(    1) = obs_type_type(RAW_STATE_VARIABLE, &
    'RAW_STATE_VARIABLE', QTY_STATE_VARIABLE, .false., .false., .false.)
obs_type_info(    2) = obs_type_type(RAW_STATE_1D_INTEGRAL, &
    'RAW_STATE_1D_INTEGRAL', QTY_1D_INTEGRAL, .false., .false., .false.)
obs_type_info(    3) = obs_type_type(RAW_LOG_TRANSFORM, &
    'RAW_LOG_TRANSFORM', QTY_1D_LOG, .false., .false., .false.)
...
obs_kind_names(357) = obs_kind_type(QTY_1D_LOG,                'QTY_1D_LOG')
