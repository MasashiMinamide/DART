...
!
! $Id: gen_sampling_err_table.f90 11371 2017-03-17 22:00:13Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/assimilation_code/programs/gen_sampling_err_table/gen_sampling_err_table.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11371 $"
character(len=128), parameter :: revdate  = "$Date: 2017-03-17 18:00:13 -0400 (Fri, 17 Mar 2017) $"
...
msgstring = '$Id: gen_sampling_err_table.f90 11371 2017-03-17 22:00:13Z nancy@ucar.edu $'
