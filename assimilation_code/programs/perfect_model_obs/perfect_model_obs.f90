...
!
! $Id: perfect_model_obs.f90 11160 2017-02-27 22:29:31Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/assimilation_code/programs/perfect_model_obs/perfect_model_obs.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11160 $"
character(len=128), parameter :: revdate  = "$Date: 2017-02-27 17:29:31 -0500 (Mon, 27 Feb 2017) $"
