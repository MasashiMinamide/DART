...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/observations/forward_operators/obs_def_cwp_mod.f90 $
...
character(len=128), parameter :: &
   source   = "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/observations/forward_operators/obs_def_cwp_mod.f90 $", &
   revision = "$Revision: 11289 $", &
   revdate  = "$Date: 2017-03-10 16:56:06 -0500 (Fri, 10 Mar 2017) $"
