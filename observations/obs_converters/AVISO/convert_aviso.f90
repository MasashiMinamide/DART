...
!
! $Id: convert_aviso.f90 11474 2017-04-13 15:26:47Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/observations/obs_converters/AVISO/convert_aviso.f90 $"
