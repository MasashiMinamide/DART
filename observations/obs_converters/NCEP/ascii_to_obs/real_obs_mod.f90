...
!
! $Id: real_obs_mod.f90 11243 2017-03-08 21:35:09Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/observations/obs_converters/NCEP/ascii_to_obs/real_obs_mod.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11243 $"
character(len=128), parameter :: revdate  = "$Date: 2017-03-08 16:35:09 -0500 (Wed, 08 Mar 2017) $"
...
! $Id: real_obs_mod.f90 11243 2017-03-08 21:35:09Z nancy@ucar.edu $
! $Revision: 11243 $
! $Date: 2017-03-08 16:35:09 -0500 (Wed, 08 Mar 2017) $
