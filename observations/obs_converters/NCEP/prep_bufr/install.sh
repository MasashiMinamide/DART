...
# DART $Id: install.sh 6727 2014-01-15 20:00:04Z hkershaw $
#
#  ------------------------------------------------------------------------
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/observations/obs_converters/NCEP/prep_bufr/install.sh $
# $Revision: 6727 $
# $Date: 2014-01-15 15:00:04 -0500 (Wed, 15 Jan 2014) $
