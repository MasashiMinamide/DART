...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/observations/obs_converters/ROMS/convert_roms_obs.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11262 $"
character(len=128), parameter :: revdate  = "$Date: 2017-03-09 15:42:15 -0500 (Thu, 09 Mar 2017) $"
...
! $Id: convert_roms_obs.f90 11262 2017-03-09 20:42:15Z nancy@ucar.edu $
! $Revision: 11262 $
! $Date: 2017-03-09 15:42:15 -0500 (Thu, 09 Mar 2017) $
