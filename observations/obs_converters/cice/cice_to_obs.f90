...
!
! $Id: cice_to_obs.f90 10977 2017-02-01 18:15:42Z thoar@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/observations/obs_converters/cice/cice_to_obs.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 10977 $"
character(len=128), parameter :: revdate  = "$Date: 2017-02-01 13:15:42 -0500 (Wed, 01 Feb 2017) $"
...
! $Id: cice_to_obs.f90 10977 2017-02-01 18:15:42Z thoar@ucar.edu $
! $Revision: 10977 $
! $Date: 2017-02-01 13:15:42 -0500 (Wed, 01 Feb 2017) $
