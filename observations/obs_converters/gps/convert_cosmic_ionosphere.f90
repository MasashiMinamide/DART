...
!
! $Id: convert_cosmic_ionosphere.f90 11498 2017-04-14 19:58:02Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/observations/obs_converters/gps/convert_cosmic_ionosphere.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11498 $"
character(len=128), parameter :: revdate  = "$Date: 2017-04-14 15:58:02 -0400 (Fri, 14 Apr 2017) $"
