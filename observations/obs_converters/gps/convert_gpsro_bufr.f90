...
!
! $Id: convert_gpsro_bufr.f90 11498 2017-04-14 19:58:02Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/observations/obs_converters/gps/convert_gpsro_bufr.f90 $"
